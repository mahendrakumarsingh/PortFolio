      ...
      <div className="contact-content">
        ...
        <div className="contact-content__visual">
          ...
          <div className="contact-content__info">
            ...
            <a href="https://github.com/mahendrakumarsingh" target="_blank" rel="noreferrer" className="contact-info-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <a href="https://www.linkedin.com/in/mahendra-kumar-singh-6132132a0/" target="_blank" rel="noreferrer" className="contact-info-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
